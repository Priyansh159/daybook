// Vendored from reactbits.dev's "Spring Check" (MIT + Commons Clause,
...
export default function SpringCheck({
  ...
  return (
    <button
      ...
      onClick={toggle}
    >
      <span className="group-focus-visible:outline-offset-[3px] group-focus-visible:[outline:2px_solid_color-mix(in_srgb,var(--sc-ink)_45%,transparent)] flex-none h-[var(--sc-box)] w-[var(--sc-box)] rounded-[var(--sc-radius)] [transition:transform_160ms_var(--sc-ease-out)] group-data-[pressed]:[transform:scale(0.95)] motion-reduce:transition-none">
        <span
          ref={boxRef}
