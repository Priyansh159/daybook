// Vendored from reactbits.dev's "Silk" (MIT + Commons Clause,
// https://github.com/DavidHDev/react-bits), TS+Tailwind variant.
// Uses @react-three/fiber + three, unlike this app's other WebGL backgrounds
// (PrismaticBurst/PaperCrumple use ogl) — added specifically for this
// component. Isolated to the lazy-loaded auth route, so it never reaches the
...
const Silk: React.FC<SilkProps> = ({ speed = 5, scale = 1, color = '#7B7481', noiseIntensity = 1.5, rotation = 0, lightMode = false }) => {
